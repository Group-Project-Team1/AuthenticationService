...
import com.example.authenticationservice.domain.AwsSecrets;
...
public class HibernateProperty {
    ...
    public HibernateProperty(){
        ...
        this.url = "jdbc:" + awsSecrets.getEngine() + "://" + awsSecrets.getHost() + ":" + awsSecrets.getPort() + "/Authentication?useSSL=false";
    }
}
